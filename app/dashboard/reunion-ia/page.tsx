  ...
  return (
    <div className="space-y-7">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-foreground">Réunion</h1>
      ...
      <div className="flex flex-wrap gap-2">
        <Link
          ...
          className="rounded-xl border border-border bg-card px-3 py-2 text-xs font-medium text-foreground transition hover:bg-muted"
        >
