  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
      <button
        ...
        className="absolute inset-0 bg-[color-mix(in_srgb,var(--ni-text)_32%,transparent)] backdrop-blur-sm"
        onClick={onClose}
      />
      <section className="ni-glass-panel relative w-full max-w-3xl overflow-hidden p-0">
        <div className="absolute inset-x-0 top-0 h-28 bg-[radial-gradient(circle_at_20%_0%,rgba(74,98,128,0.12),transparent_55%),linear-gradient(135deg,rgba(255,255,255,0.65),transparent)] dark:bg-[radial-gradient(circle_at_20%_0%,rgba(255,255,255,0.08),transparent_55%)]" />
        <div className="relative flex items-start justify-between gap-6 border-b border-border/60 px-7 py-6">
          <div>
        ...
        <div className="grid gap-4 px-7 py-6 md:grid-cols-2">
          {[
            ...
            <div
              ...
              className={
                index === 1
                  ? "rounded-2xl border border-[color-mix(in_srgb,var(--ni-accent)_25%, transparent)] bg-[var(--ni-accent-soft)] px-5 py-5 text-[var(--ni-text)] shadow-[var(--ni-shadow-soft)] dark:bg-[var(--ni-accent)]/20 dark:text-foreground"
                  : "ni-soft-panel p-5"
              }
            >
